...
func registerCalendarCommands(app *command.App, provider *resources.Provider) {
	app.AddCommand(&command.Command{
		...
		Description: command.Description{
			Short: "Create a new CalDAV calendar collection",
			Long: `Creates a new calendar collection on the CalDAV server using MKCALENDAR. The
calendar can hold both VTODO tasks and VEVENT events. If no ID is specified, one
is generated by sanitizing the display name (lowercased, spaces to hyphens,
non-alphanumeric characters removed).`,
		...
		Examples: []command.Example{
			{
				Description: "Create a calendar with auto-generated ID",
				Command:     "caldav create_calendar --name 'Work Tasks'",
			},
			{
				Description: "Create a calendar with a specific ID",
				Command:     "caldav create_calendar --name 'Personal' --id personal --description 'Personal tasks and events'",
			},
		},
		SeeAlso: []string{"caldav-create_task", "caldav-create_event"},
